...
{-| A record alias. The library operates around the concept of an Elm record 
that must have a member named `doc` of type `TopLevel`, and a member named `idr` 
of type `Identifier`. Even though the record may have other members, this library
